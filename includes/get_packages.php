<div class="columns draggable ui-package transitions-enabled" data-item = "package" data-pid = "0" data-pname="Static" data-pprice="2500">
  ...
  <ul class="pricing-table">
    ...
    <li class="bullet-item">Image gallery slider</li>
    <li class="bullet-item">Social links</li>
    <li class="bullet-item">Basic google map</li>
...
<div class="columns draggable ui-package transitions-enabled" data-item = "package" data-pid = "2" data-pname="Standard" data-pprice="9000">
  ...
  <ul class="pricing-table">
    ...
    <li class="bullet-item">Image gallery slider</li>
    <li class="bullet-item">1 product category</li>
    <li class="bullet-item">Social links</li>
    <li class="bullet-item">Customised google map</li>
    <li class="bullet-item">Video embed</li>
    <li class="bullet-item">Google analytics setup</li>
    <li class="bullet-item">Basic on-page SEO</li>
    <!--<li class="cta-button"><a class="button" href="#">Buy Now</a></li>-->
 ...
 <div class="columns draggable ui-package transitions-enabled" data-item = "package" data-pid = "3" data-pname="Premium" data-pprice="12000">
  ...
  <ul class="pricing-table">
    ...
    <li class="bullet-item">Image/Video gallery slider</li>
    <li class="bullet-item">3 product categories</li>
    <li class="bullet-item">Social feed intergration</li>
    <li class="bullet-item">Customised google map</li>
    <li class="bullet-item">Video embed</li>
    <li class="bullet-item">Google analytics setup</li>
    <li class="bullet-item">Basic on-page SEO</li>
